...
from src.modules.streaming.application.ports.scrub_preview_locator_port import (
...
if TYPE_CHECKING:
    from src.modules.streaming.application.ports.runtime_config_ports import ThumbnailConfigPort
