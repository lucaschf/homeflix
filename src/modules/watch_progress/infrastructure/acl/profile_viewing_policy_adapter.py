"""Adapter implementing Watch Progress' ``ProfileViewingPolicyPort``.

The only adapter in the Watch Progress BC that reads through Identity's
Unit of Work; the presentation layer imports only Identity's public
``resolve_profile_id`` dependency (ADR-009).
"""
