...
_SUBPROCESS_TARGET = (
    "src.modules.streaming.infrastructure.streaming.thumbnail_service.subprocess.run"
)
_WHICH_TARGET = "src.modules.streaming.infrastructure.streaming.thumbnail_service.shutil.which"
