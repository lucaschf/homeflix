...
class TestMovieIdCreation:
    ...
    def test_should_create_with_valid_format(self):
        from src.shared_kernel.value_objects import MovieId
...
class TestSeriesIdCreation:
    ...
    def test_should_create_with_valid_format(self):
        from src.shared_kernel.value_objects import SeriesId
...
class TestSeasonIdCreation:
    ...
    def test_should_create_with_valid_format(self):
        from src.shared_kernel.value_objects import SeasonId
...
class TestEpisodeIdCreation:
    ...
    def test_should_create_with_valid_format(self):
        from src.shared_kernel.value_objects import EpisodeId
...
class TestMediaIdEquality:
    ...
    def test_movie_id_should_not_equal_series_id_with_same_random_part(self):
        from src.shared_kernel.value_objects import MovieId, SeriesId
...
class TestParseMediaId:
    ...
    def test_should_parse_movie_id(self):
        from src.shared_kernel.value_objects import MovieId, parse_media_id
    ...
    def test_should_parse_series_id(self):
        from src.shared_kernel.value_objects import SeriesId, parse_media_id
    ...
    def test_should_parse_episode_id(self):
        from src.shared_kernel.value_objects import EpisodeId, parse_media_id
    ...
    def test_should_parse_season_id(self):
        from src.shared_kernel.value_objects import SeasonId, parse_media_id
    ...
    def test_should_raise_error_for_unknown_prefix(self):
        from src.shared_kernel.value_objects import parse_media_id
